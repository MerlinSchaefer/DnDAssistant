...
def get_document_retrieval_tool(
    ...
    Args:
        retriever: The retriever to use for retrieving documents, e.g., based on Cognitive Search.
    """
    tool = lc_tools.retriever.create_retriever_tool(
        ...
        These will be documents the users have uploaded, such as texts of law.""",
    )
